          ...
          {   /* 1nd item */}
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <a href="https://youtu.be/1FOgoble-Vs">
                <Image className="max-w-full mx-auto md:max-w-none h-auto" src={FeatImage05} width={540} height={405} alt="git-finder"  />
                <p className='text-center text-purple-600 hover:underline'>Click on the image to see the project in detailed</p>
                </a>
              </div>
              {/* Content */}
                ...
                <div className="font-architects-daughter text-xl text-purple-600 mb-4">BI project </div>
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Pre-processing using by python</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Created a "Star-Schema" model</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Developed analysis screens to help gain insights from the data.</span>
                    </li>
                  </ul>
                </div>
              </div>
             ...
             {   /* 3nd item */}
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl text-purple-600 mb-2">SQL project</div>
                  <h3 className="h3 mb-3">Developed in SQL Server Managment Studio</h3>
            ...
            {   /* 4nd item */}
              ...
              {/* Image */}
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
              <a href="https://github.com/YahavMesika/Hackaton_Taxi_Prediction/blob/main/Hackathon2023.ipynb">
                        ...
                        <div className="md:pr-4 lg:pr-12 xl:pr-16">
                          ...
                          <ul className="text-lg text-gray-400 -mb-2">
                            <li className="flex items-center mb-2">
                              ...
                              <span> Created a football database </span>
                            </li>
                            <li className="flex items-center mb-2">
                              <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                              </svg>
                              <span> Developed and implemented various database functions to handle data manipulation tasks. </span>
                            </li>
                            <li className="flex items-center">
                              <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
