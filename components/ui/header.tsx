                  ...
                  <Link href="https://www.linkedin.com/in/yahav-mesika/">
                    <a className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="LinkedIn">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M20.813 3.043h-17.626c-.608 0-1.187.244-1.613.678-.426.435-.664 1.023-.664 1.642v15.075c0 .62.238 1.207.664 1.642.426.435 1.005.678 1.613.678h17.626c.608 0 1.187-.244 1.613-.678.426-.435.664-1.022.664-1.642v-15.075c0-.619-.238-1.207-.664-1.642-.426-.434-1.005-.678-1.613-.678zm-17.626 17.629v-15.075h17.626v15.075h-17.626zm8.813-10.457h-1.476v-.676c0-.826-.614-1.514-1.4-1.514-.786 0-1.413.688-1.413 1.514v.676h-1.476v-.676c0-1.21.972-2.2 2.188-2.2 1.216 0 2.187.99 2.187 2.2v.676zm0 0"></path>
                        <path d="M6.836 9.19h2.976v7.333h-2.976zm0 0"></path>
                        <path d="M8.585 5.27c-.918 0-1.664.746-1.664 1.663s.746 1.664 1.664 1.664c.918 0 1.663-.746 1.663-1.664s-.745-1.663-1.663-1.663zm0 0"></path>
                      </svg>
                    </a>
                  </Link>
                </li>
